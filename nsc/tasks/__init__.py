...
def get_task(
    ...
    from nsc.tasks.tokenization_repair import TokenizationRepair
    from nsc.tasks.tokenization_repair_plus import TokenizationRepairPlus
    from nsc.tasks.graph_sed_sequence import GraphSEDSequence
    from nsc.tasks.sed_sequence import SEDSequence
    from nsc.tasks.graph_sec_nmt import GraphSECNMT
    from nsc.tasks.sec_nmt import SECNMT
    from nsc.tasks.graph_sec_words_nmt import GraphSECWordsNMT
    from nsc.tasks.sec_words_nmt import SECWordsNMT
