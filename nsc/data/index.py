...
from nsc.data.utils import flatten, NeighborFn
from nsc.modules import utils as mod_utils, embedding, encoders
from nsc.utils import common, io, to
...
class NNIndex:
    ...
    def create(
        ...
        index_time_params = {
            "M": m,
            "indexThreadQty": int(os.getenv("NSC_INDEX_NUM_THREADS", len(os.sched_getaffinity(0)))),
